...
// DefaultLLMModel is the default Cerebras chat model when none is specified.
const DefaultLLMModel = "llama3.1-8b"

// LLMService implements services.LLMService using Cerebras inference API (OpenAI-compatible).
type LLMService struct {
	client *openai.Client
	model  string
}

// NewLLMService creates a Cerebras LLM service.
