...
// DefaultLLMModel is the default Mistral chat model when none is specified.
const DefaultLLMModel = "mistral-small-latest"

// LLMService implements services.LLMService using Mistral's OpenAI-compatible chat API.
type LLMService struct {
	client *openai.Client
	model  string
}

// NewLLMService creates a Mistral LLM service.
